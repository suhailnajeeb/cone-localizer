...
# Get argument first
# nnPath = str((Path(__file__).parent / Path('../models/yolov8n_det_3510_yb_6shave.blob')).resolve().absolute())
nnPath = str((Path(__file__).parent / Path('../models/yolov8nultra_cones_yb_6shave.blob')).resolve().absolute())
...
camRgb.setImageOrientation(dai.CameraImageOrientation.VERTICAL_FLIP)    # Image flipped vertically due to camera orientation
